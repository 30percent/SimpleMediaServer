...
class MeekroDB {
  ...
  protected function preparseQueryParams() {
    ...
    $types = array(
      ...
      $this->param_char . 'ts'  // my attempt to allow table/row names as params
    );
  ...
  protected function tabescape($str) { return "`" . $this->get()->real_escape_string(strval($str)) . "`"; }
  ...
  protected function parseQueryParams() {
    ...
    foreach ($chunkyQuery as $chunk) {
      ...
      else if ($type == 'ts') $result = $this->tabescape($arg);
